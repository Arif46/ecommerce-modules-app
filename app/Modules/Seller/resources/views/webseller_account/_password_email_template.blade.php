                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="h1" style="font-family: 'Poppins', height:120px; sans-serif; color:#4285f4; font-weight:600; line-height:20px; font-size: 14px; text-decoration:none;   padding-bottom:10px;">           
                                                            ...
                                                            <center><a href="https://afshini.com"><img src="https://afshini.com/frontend/assets/img/logo/logo-2.png" style="height: 50px; width: 180px;" alt="img"></a>
                                                            </center>
                                                        </td>
                                                                  ...
                                                                  <tr style="">
                                                                    <td class="text" style="font-family: 'Poppins', sans-serif; color:#383838; font-weight:400; line-height:26px; font-size: 14px; text-decoration:none; padding:66px 20px 68px; background: #dbffd2">
                                                                        <div class="rocket-txt">
                                                                            ...
                                                                            margin: auto;" href="{{ URL::to('seller-send-mail-for-password-reset')}}/{{$user_data->remember_token}}"> Reset Password </a>
