...
@section('body')
    <!-- breadcrumb area -->
        <div class="breadcrumb-area bg-img pt-50 pb-50 default-overlay-2" style="background-image: url('{{URL::to('')}}/uploads/seller/{{$user_data->relSellerProfile->image_link}}');">
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <h2>@if(!empty($user_data))
                                {{$user_data->shop_name}}                      
                                @endif </h2>
                    <ul>
                        <li>
                        ...
                        <li class="active"> 
                            @if(!empty($user_data))                               
                                   <a href="{{ route('shop.shoplist') }}">{{$user_data->shop_name}} </a>                     
                                @endif  </li>
                    </ul>
                </div>
            </div>
                                            ...
                                            <div class="product-item">
                                                <div class="product-image-hover zoom-hover">
                                                    ...
                                                    <div class="product-hover">
                                                     ...
                                                     <!--  <a href="#" class="shop-cart-add" product_id="{{$product->product_id}}" data_href="{{route('web.cart.add')}}" product_quantity="1"><i class="fa fa-cart-plus" aria-hidden="true"></i></a> -->
                                                        ...
                                                        <a class="shop-now-btn shop-card shop-cart-add" product_id="{{$product->product_id}}" data_href="{{route('web.cart.add')}}" product_quantity="1"><i class="icon icon-FullShoppingCart"></i> Buy Now</a>
                                                    </div>
                                                </div>
