...
<head>
    ...
    <meta name="description"
          content="Afshini Online Shopping in Bangladesh - afshini.com is Online Shopping at Low price in Dhaka, Chittagong, Khulna, Sylhet , Mymensingh , Rajshahi and Barishal.">
...
@include('Web::customer.customer_header')
...
@include('Web::customer.customer_js_script')
@yield('script')
...
<div class="modal fade" id="chanePasswordModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php
            $url = route('customer.do.change.password');
            ?>
            ...
            <div class="modal-body">
                ...
                <div class="form-fields">
                    ...
                    <p>
                        {!! Form::label('old_password', 'Old Password', array('class' => '')) !!} <span
                                class="required"> *</span>
                    ...
                    <p>
                        {!! Form::label('password', 'Password', array('class' => '')) !!} <span
                                class="required"> *</span>
                    ...
                    <p>
                        {!! Form::label('password_confirmation', 'Confirm Password', array('class' => '')) !!} <span
                                class="required"> *</span>
