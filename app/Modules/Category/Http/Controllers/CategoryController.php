...
class CategoryController extends Controller
{
        ...
        if(!$data )
        {
            ...
            // Check image file exists or not
                ...
                // Check image size
                        ...
                        // if($category_image->getClientSize() > 512)
                        // {
            ...
            Session::flash('info', 'category already added!');
        }
        return redirect()->back();
     ...
     public function edit($id)
    {
        ...
        if(!empty($category_self_relation)){
                ...
                // Check image size
                        ...
                        if($category_image) {
                            ...
                            if($request->file('image_link') != null){
                                ...
                                File::delete($this->category_image_path.'/orginal_image/'.$model->image_link);
                                File::delete($this->category_image_path.'/800x800/'.$model->image_link);  
                            }
    ...
    public function search(Request $request)
    {
        ...
        if($this->isGetRequest())
        {
            ...
            $data = $model->select('category.*')->paginate(30);
        }else{
