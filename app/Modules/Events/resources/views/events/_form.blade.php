<div class="body">
    ...
    <div class="row clearfix">
        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 form-control-label">
            <label>Notices Title</label>
        </div>
        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
            <div class="form-group">
                <div class="form-line">
                    {!! Form::text('title',Request::old('title'),['id'=>'title','class' => 'form-control','required'=> 'required',  'title'=>'Enter Notices title', 'onkeyup'=>"convert_to_slug();"]) !!}
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
            <div class="form-group">
                <div class="form-line">
                    {!! Form::label('image_link', 'File', array('class' => 'col-form-label')) !!}
                    <span class="error">Supported format :: PDF</span>
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
            <div class="form-group">
                <div class="form-line">
                    {!! Form::Select('type',array('home'=>'Home','others'=>'Others'),Request::old('type'),['id'=>'', 'class'=>'form-control']) !!}
