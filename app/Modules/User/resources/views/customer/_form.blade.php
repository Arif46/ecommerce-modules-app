    ...
    <div class="body"> 
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
                <div class="form-group">
                    <div class="form-line">
                        {!! Form::Select('type',array('customer'=>'Customer'),Request::old('type'),['id'=>'', 'class'=>'form-control']) !!}
                        {!! $errors->first('type') !!}
                    </div>
                </div>
            </div>
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
                <div class="form-group">
                    <div class="form-line"> 
                        {!! Form::Select('roles_id',array('3'=>'3'),Request::old('roles_id'),['id'=>'roles_id', 'class'=>'form-control']) !!}
