                                               ...
                                               <!--  <tr>
                                                ...
                                                <tr>
                                                    <td colspan= "2">
                                                        ...
                                                        $id = $values->users_id;
                                                        ?>
                                                        <a href="{{ route('admin.seller.destroy', $id) }}" class=" btn-warning" onclick="return confirm('Are you sure to Cancel?')">Cancel</a>
                                                        <a href="{{ route('admin.seller.deletes', $id) }}" class=" btn-danger" onclick="return confirm('Are you sure to Delete?')">Delete</a>
                                                        <a href="{{ route('admin.seller.show', $id) }}" class="btn-success">Show</a>
                                                        <a href="{{ route('admin.seller.edit', $id) }}" class="btn-primary">Edit</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
