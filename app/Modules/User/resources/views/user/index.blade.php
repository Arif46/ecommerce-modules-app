                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-3 text-right">
                                    @if((Auth::user())->type == \App\AppConfig::USER_ROLE_TYPE_SUPER_ADMIN)
                                        <a href="{{route('admin.user.create')}}" class="btn btn-primary">Add user As
                                            admin</a>
                                    @endif
                                </div>
                            </div>
                                            ...
                                            @if(!empty($data))
                                                ...
                                                @foreach($data as $values)
                                                    ...
                                                    <!-- <td>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.user.show', $values->id) }}"
                                                               class="btn btn-primary">Show</a>

                                                            <a href="{{ route('admin.user.edit', $values->id) }}"
                                                               class="btn btn-info">Edit</a>

                                                            <a href="{{ route('admin.user.destroy', $values->id) }}"
