                                      ...
                                      @if(!empty($data) )
                                       ...
                                       @foreach($data as $values)
                                           <tr>
                                            ...
                                            <img width="250" src="{{ url('uploads/brand/800x800/' . $values->image_link) }}">
                                            @endif
                                            </td>
                                            <td>
                                                <a href="{{ route('admin.brand.show', $values->id) }}" class="btn btn-primary">show</a>
                                                <a href="{{ route('admin.brand.edit', $values->id) }}" class="btn btn-info" >Edit</a>
                                                <a href="{{ route('admin.brand.destroy', $values->id) }}" class="btn btn-danger" onclick="return confirm('Are you sure to Cancel?')" >Cancel</a>
                                            </td>
